...
class Git_igniter_model extends CI_Model {
	...
	*********************************************************************************************************************/
	...
	public function __construct(){
		...
		$this->load->database();
		$this->load->config('git_igniter', TRUE);
		
		$this->table = $this->config->item( 'gh_table', 'git_igniter' );
		$this->where_field = $this->config->item( 'gh_where_field', 'git_igniter' );
		$this->token_field = $this->config->item( 'gh_token_field', 'git_igniter' );
